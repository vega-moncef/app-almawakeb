<template>
  <VerticalLayout>
    <PageTitle title="Wizard" subtitle="Form" />
    <b-row>
      <b-col cols="12">
        <UIComponentCard id="basic-wizard" title="Simple">
          <form-wizard color="#604ae3" back-button-text="Back To Previous" next-button-text="Next Step"
                ...
                <b-col cols="12">
                  <div class="avatar-lg mb-3">
                    <div
                      ...
                      <input class="hidden d-none" type="file" id="imageInput" accept="image/*" />
        ...
        <UIComponentCard id="custom-wizard" title="Custom Title">
          <form-wizard shape="tab" color="#604ae3" back-button-text="Back To Previous" next-button-text="Next Step"
            finish-button-text="Finish">
