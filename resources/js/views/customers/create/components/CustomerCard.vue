  ...
  <b-card no-body class="overflow-hidden">
    <b-card-body>
      ...
      <div class="mt-5 pt-3 ms-1">
        ...
        <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Contact Number : </span> +231
          06-75820711</p>
        <p class="text-muted fw-medium fs-14 mb-1"><span class="text-dark me-1">Address : </span> Schoolstraat 161
          5151 HH Drunen</p>
        <b-row class="mt-3 justify-content-between">
          ...
          <b-col lg="4">
            ...
            <h5 class="mb-0 fw-semibold text-dark">{{ currency }}142,465</h5>
          </b-col>
        </b-row>
