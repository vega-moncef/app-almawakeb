<template>
  <VerticalLayout>
    <PageTitle title="Calendar" subtitle="Pages" />
    <b-row>
      <b-col cols="12">
        <b-card no-body>
          <b-card-body>
            <b-row>
              <b-col xl="3">
                ...
                <div id="external-events">
                  ...
                  <template v-for="event in externalEvents" :key="event.id">
...
import { externalEvents, options, initialEvents } from '@/views/pages/calendar/components/data'
